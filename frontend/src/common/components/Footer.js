    ...
    return (
        ...
        <footer>
            <Container>
                ...
                {/* One grid, four aligned columns, filled column by column: the
                    links read top-to-bottom like a list and every column starts
                    on the same track, which two wrapping rows never managed.
                    Source order still runs support first, then the legal set —
